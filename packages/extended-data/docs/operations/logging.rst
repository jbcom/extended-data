...
Logging helpers share the package’s data-lowering and redaction
behavior. When messages include JSON-like payloads, secret-like keys and
known caller-provided values can be withheld before output.
