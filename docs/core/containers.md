...
Tier 2 wraps Python data shapes with `ExtendedString`, `ExtendedDict`,
`ExtendedList`, `ExtendedTuple`, and `ExtendedSet`. Construction and mutation
promote nested values, so method chains survive normal Python literals.
