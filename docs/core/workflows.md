...
Sync primitives compare rendered output before writing. That gives higher layers, such as `vendor-fabric`, a base local file sync operation without reimplementing export, redaction, and metadata handling.
