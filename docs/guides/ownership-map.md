...
| Vendor capability dispatch and provider SDK adapters | `jbcom/vendor-fabric` | `vendor-fabric[...]` |
...
| SecretSync agent tool wrappers | `jbcom/agentic-fabric` | `agentic-fabric[...]` |
| Agent framework integrations | `jbcom/agentic-fabric` | `agentic-fabric[...]` |
