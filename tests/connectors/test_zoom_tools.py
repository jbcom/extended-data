...
class TestToolDefinitions:
    ...
    def test_tool_definitions_exist(self):
        ...
        from extended_data.connectors.zoom.tools import TOOL_DEFINITIONS
...
class TestListUsers:
    ...
    def test_list_users_basic(self, mock_connector_class):
        """Test listing users."""
        from extended_data.connectors.zoom.tools import list_users
...
class TestGetUser:
    ...
    def test_get_user_basic(self, mock_connector_class):
        ...
        from extended_data.connectors.zoom.tools import get_user
...
class TestListMeetings:
    ...
    def test_list_meetings_basic(self, mock_connector_class):
        ...
        from extended_data.connectors.zoom.tools import list_meetings
...
class TestGetMeeting:
    ...
    def test_get_meeting_basic(self, mock_connector_class):
        ...
        from extended_data.connectors.zoom.tools import get_meeting
...
class TestGetTools:
    ...
    def test_get_strands_tools(self):
        ...
        from extended_data.connectors.zoom.tools import get_strands_tools
    ...
    def test_get_langchain_tools_import_error(self):
        ...
        from extended_data.connectors.zoom.tools import get_langchain_tools
    ...
    def test_get_crewai_tools_import_error(self):
        ...
        from extended_data.connectors.zoom.tools import get_crewai_tools
