...
from extended_data.connectors.github import GitHubConnector, GitHubFallbackError, build_github_actions_workflow
...
def test_update_repository_file_allows_empty_payloads_when_requested() -> None:
    ...
    result = connector.update_repository_file("empty.txt", "", file_sha="abc123", allow_empty=True, allow_encoding=False)
