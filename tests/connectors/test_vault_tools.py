...
class TestVaultToolDefinitions:
    ...
    def test_tool_definitions_exist(self):
        ...
        from extended_data.connectors.vault.tools import TOOL_DEFINITIONS
...
class TestReadSecret:
    ...
    def test_read_secret_found(self, mock_connector_class):
        ...
        from extended_data.connectors.vault.tools import read_secret
...
class TestGetTools:
    ...
    def test_get_strands_tools(self):
        ...
        from extended_data.connectors.vault.tools import get_strands_tools
...
class TestLangChainIntegration:
    ...
    def test_get_langchain_tools_without_langchain(self):
        ...
        from extended_data.connectors.vault.tools import get_langchain_tools
...
class TestCrewAIIntegration:
    ...
    def test_get_crewai_tools_without_crewai(self):
        ...
        from extended_data.connectors.vault.tools import get_crewai_tools
