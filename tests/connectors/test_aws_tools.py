...
class TestAWSToolDefinitions:
    ...
    def test_tool_definitions_exist(self):
        ...
        from extended_data.connectors.aws.tools import TOOL_DEFINITIONS
...
class TestGetSecret:
    ...
    def test_get_secret_basic(self, mock_connector_class):
        ...
        from extended_data.connectors.aws.tools import get_secret
...
class TestGetTools:
    ...
    def test_get_strands_tools(self):
        ...
        from extended_data.connectors.aws.tools import get_strands_tools
    ...
    def test_get_tools_auto_fallback(self, mock_is_available):
        ...
        from extended_data.connectors.aws.tools import get_tools
