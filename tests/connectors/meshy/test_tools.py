"""Tests for extended_data.connectors.meshy.tools module.
...
class TestToolDefinitions:
    ...
    def test_tool_definitions_has_all_tools(self):
        ...
        from extended_data.connectors.meshy.tools import TOOL_DEFINITIONS
...
class TestStrandsTools:
    ...
    def test_get_strands_tools_returns_functions(self):
        ...
        from extended_data.connectors.meshy.tools import get_strands_tools
...
class TestText3DGenerate:
    ...
    def test_generation_with_defaults(self):
        ...
        with patch("extended_data.connectors.meshy.text3d.generate", return_value=mock_result) as mock_gen:
...
class TestImage3DGenerate:
    ...
    def test_successful_image_to_3d(self):
        ...
        from extended_data.connectors.meshy.tools import image3d_generate
        ...
        with patch("extended_data.connectors.meshy.image3d.generate", return_value=mock_result):
...
class TestRigModel:
    ...
    def test_successful_rigging_with_wait(self):
        ...
        from extended_data.connectors.meshy.tools import rig_model
...
class TestApplyAnimation:
    ...
    def test_successful_animation(self):
        ...
        from extended_data.connectors.meshy.tools import apply_animation
        ...
        with patch("extended_data.connectors.meshy.animate.apply", return_value=mock_result):
    ...
    def test_animation_without_wait(self):
        ...
        with patch("extended_data.connectors.meshy.animate.apply", return_value="anim_pending"):
            result = apply_animation(
                model_id="model",
                animation_id=1,
                wait=False,
...
class TestRetextureModel:
    ...
    def test_successful_retexture(self):
        ...
        from extended_data.connectors.meshy.tools import retexture_model
        ...
        with patch("extended_data.connectors.meshy.retexture.apply", return_value=mock_result):
...
class TestListAnimations:
    ...
    def test_list_all_animations(self):
        ...
        from extended_data.connectors.meshy.tools import list_animations
...
class TestGetAnimation:
    ...
    def test_get_existing_animation(self):
        ...
        from extended_data.connectors.meshy.tools import get_animation
    ...
    def test_get_nonexistent_animation(self):
        ...
        with patch("extended_data.connectors.meshy.animations.ANIMATIONS", {}):
...
class TestLangChainTools:
    ...
    def test_get_langchain_tools_returns_structured_tools(self):
        ...
        from extended_data.connectors.meshy.tools import get_langchain_tools
...
class TestCrewAITools:
    ...
    def test_get_crewai_tools_requires_crewai(self):
        ...
        with patch.dict("sys.modules", {"crewai": None, "crewai.tools": None}):
            from extended_data.connectors.meshy import tools as meshy_tools
