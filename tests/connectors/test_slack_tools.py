...
def mock_slack_sdk():
    ...
    # Insert into sys.modules before importing extended_data.connectors.slack
    with patch.dict(
        sys.modules,
        {
...
class TestSlackToolDefinitions:
    ...
    def test_tool_definitions_exist(self, mock_slack_sdk):
        ...
        from extended_data.connectors.slack.tools import TOOL_DEFINITIONS
...
class TestListChannels:
    ...
    def test_list_channels_basic(self, mock_slack_sdk):
        ...
        from extended_data.connectors.slack.tools import list_channels
...
class TestListUsers:
    ...
    def test_list_users_basic(self, mock_slack_sdk):
        ...
        from extended_data.connectors.slack.tools import list_users
...
class TestSendMessage:
    ...
    def test_send_message_basic(self, mock_slack_sdk):
        ...
        from extended_data.connectors.slack.tools import send_message
...
class TestGetChannelHistory:
    ...
    def test_get_channel_history_basic(self, mock_slack_sdk):
        ...
        from extended_data.connectors.slack.tools import get_channel_history
...
class TestGetTools:
    ...
    def test_get_strands_tools(self, mock_slack_sdk):
        ...
        from extended_data.connectors.slack.tools import get_strands_tools
