...
_LAZY_EXPORTS = {
    ...
    "BuiltinConnectorAdapter": ("extended_data.connectors", "BuiltinConnectorAdapter"),
    "ConnectorAdapter": ("extended_data.connectors", "ConnectorAdapter"),
    ...
    "get_connector_adapter": ("extended_data.connectors", "get_connector_adapter"),
...
def __getattr__(name: str) -> Any:
    """Lazily expose integrated connectors and processors at the package root."""
