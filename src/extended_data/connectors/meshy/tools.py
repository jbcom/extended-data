...
def rig_model(model_id: str, wait: bool = True) -> dict[str, Any]:
    ...
    """
    from extended_data.connectors.meshy import rigging
...
def apply_animation(model_id: str, animation_id: int, wait: bool = True) -> dict[str, Any]:
    ...
    """
    from extended_data.connectors.meshy import animate
...
def retexture_model(
    ...
    """
    from extended_data.connectors.meshy import retexture
...
def list_animations(category: str = "", limit: int = 50) -> dict[str, Any]:
    ...
    """
    from extended_data.connectors.meshy.animations import ANIMATIONS
